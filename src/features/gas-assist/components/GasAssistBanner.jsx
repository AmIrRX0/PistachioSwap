...
/**
 * Presents the active 0x Gas Assist quote and fee/minimum information.
 * @param {{quote: object|null, sellToken: object|null, buyToken: object|null}} props Banner data.
 * @returns {import('react').ReactElement} Existing Gas Assist aside.
 * @sideEffects None.
 */
