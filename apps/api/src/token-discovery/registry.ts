...
const entries: readonly Entry[] = [
    ...
    { chainId: 34443, name: 'Mode', active: true, native: { name: 'Ether', symbol: 'ETH', coinGeckoId: 'ethereum' }, wrappedNative: { address: '0x4200000000000000000000000000000000000006', name: 'Wrapped Ether', symbol: 'WETH' }, providers: { geckoTerminalNetwork: 'mode', coinGeckoNetwork: 'mode', dexScreenerChain: 'mode', moralisChain: null, alchemyNetwork: 'mode-mainnet', rpcEnv: 'MODE_RPC_URL', goPlusChainId: null } },
    { chainId: 1088, name: 'Metis Andromeda', active: true, native: { name: 'Metis', symbol: 'METIS', coinGeckoId: 'metis-token' }, wrappedNative: { address: '0x75cb093e4d61d2a2ca951a3a4c80a96e8793142', name: 'Wrapped Metis', symbol: 'WMETIS' }, providers: { geckoTerminalNetwork: 'metis', coinGeckoNetwork: 'metis', dexScreenerChain: 'metis', moralisChain: null, alchemyNetwork: 'metis-mainnet', rpcEnv: 'METIS_RPC_URL', goPlusChainId: null } },
    ...
    { chainId: 1284, name: 'Moonbeam', active: true, native: { name: 'Glimmer', symbol: 'GLMR', coinGeckoId: 'moonbeam' }, wrappedNative: { address: '0xacc15dc74880c9944775448304b263d191c6077f', name: 'Wrapped Glimmer', symbol: 'WGLMR' }, providers: { geckoTerminalNetwork: 'moonbeam', coinGeckoNetwork: 'moonbeam', dexScreenerChain: 'moonbeam', moralisChain: null, alchemyNetwork: 'moonbeam-mainnet', rpcEnv: 'MOONBEAM_RPC_URL', goPlusChainId: '1284' } },
